...
def generar_reporte():
    try:
        ...
        font_title = safe_font(font_bold_path, 23)
        font_body = safe_font(font_regular_path, 24)
        font_bold = safe_font(font_bold_path, 24)
        ...
        for linea in titulo_lineas:
            ...
            linea_x = x0 + (max_width - linea_width) / 2 - 20
